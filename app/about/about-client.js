    ...
    <div className="about-page">
      ...
      <main id="about-main">
        ...
        <section className="about-editorial about-origin" aria-labelledby="origin-title">
          <div className="about-placeholder" role="img" aria-label="Editorial portrait space reserved for Daniel Stanford in Da Nang"><span>Daniel Stanford · Da Nang</span></div>
