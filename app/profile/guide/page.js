...
export default async function BodySensesGuide({ searchParams }) {
  ...
  return <main className={styles.page}>
    ...
    <section className={styles.hero}><p>Your guide</p><h1>Come back to<br />your senses.</h1><div><span>Your primary pathway</span><strong>{primary}</strong><p>{pathwayCopy[primary]}</p></div></section>
