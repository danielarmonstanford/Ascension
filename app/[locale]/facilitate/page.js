...
import { VietnameseFacilitatePage } from "../../_components/vietnamese-pages";
...
export default async function LocalizedFacilitatePage({ params }) {
  ...
  if (locale === "vi") return <VietnameseFacilitatePage />;
  if (locale !== "en") return <TranslatedInfoPage locale={locale} page="facilitate" />;
