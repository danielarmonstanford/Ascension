...
export const profileDeliveryCopy = {
  en: {
    ...
    emailSupportingCopy: "Enter your email to receive your ASCENSION pathway, your complimentary Body & Senses Guide, and experience recommendations tailored to you.",
    emailLabel: "Email address",
    emailAssurance: "We’ll use your email to deliver exactly what you requested. ASCENSION updates are entirely optional.",
    transactionalConsent: "I agree to ASCENSION using my profile to deliver the requested pathway and guide.",
    marketingConsent: "I’d like to receive optional ASCENSION updates about future experiences and editions.",
  ...
  fr: {
    emailHeading: "OÙ SOUHAITEZ-VOUS RECEVOIR VOTRE GUIDE ET VOS RÉSULTATS PERSONNALISÉS ?",
    emailSupportingCopy: "Indiquez votre adresse e-mail pour recevoir votre parcours ASCENSION, votre guide Corps & Sens offert, ainsi que des recommandations adaptées à votre expérience.",
    emailLabel: "Adresse e-mail",
    emailAssurance: "Nous utiliserons votre adresse uniquement pour vous envoyer les éléments demandés. Les actualités ASCENSION restent entièrement facultatives.",
    transactionalConsent: "J’accepte qu’ASCENSION utilise mon profil pour envoyer le parcours et le guide demandés.",
    marketingConsent: "Je souhaite recevoir, de façon facultative, les actualités ASCENSION sur les prochaines expériences et éditions.",
