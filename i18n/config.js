...
export const localeConfig = {
  ...
  fr: { code: "fr", htmlLang: "fr", shortLabel: "FR", label: "Français", status: "draft" },
  vi: { code: "vi", htmlLang: "vi", shortLabel: "VI", label: "Tiếng Việt", status: "draft" },
  ko: { code: "ko", htmlLang: "ko", shortLabel: "KO", label: "한국어", status: "draft" },
  "zh-hans": { code: "zh-hans", htmlLang: "zh-Hans", shortLabel: "中文", label: "简体中文", status: "draft" },
};
