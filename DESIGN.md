...
**The Collaborator DAY/DUSK Rhythm.** Facilitator, venue and sponsorship detail pages open through a DUSK photographic threshold, then release into a bright DAY reading field built from mist and shell with deep-ocean text. Sunlight gold is reserved for decisive actions. This creates tonal relief for long-form commercial material without copying another wellness brand, abandoning ASCENSION typography, or turning every section into a card.
