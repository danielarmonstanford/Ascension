...
**The SOUND Stage Rule.** SOUND has two deliberate responsive architectures. Desktop is a full-bleed Vietnamese film stage: screened Night Sea motion behind oversized Lovine, copper modalities, support copy and the two listening controls. MEDITATE NOW opens a contained Tibetan sound player over the same moving stage; FILM SOUND and meditation audio remain mutually exclusive. Mobile retains the ear illustration as its quiet ground and does not replace it with motion until the visitor explicitly selects FILM SOUND. Never collapse the desktop treatment back into a video card on a pale section.
